    ...
    GstVideoInfo * from)
{
  ...
  dest->bbox.x = (gint) (self->bbox.x * hfactor);
  dest->bbox.y = (gint) (self->bbox.y * vfactor);

  dest->bbox.width = (gint) (self->bbox.width * hfactor);
  dest->bbox.height = (gint) (self->bbox.height * vfactor);
    ...
    GstVideoInfo * from)
{
  ...
  self->bbox.x = (gint) (self->bbox.x * hfactor);
  self->bbox.y = (gint) (self->bbox.y * vfactor);

  self->bbox.width = (gint) (self->bbox.width * hfactor);
  self->bbox.height = (gint) (self->bbox.height * vfactor);
}
